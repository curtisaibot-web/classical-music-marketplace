    ...
    .values([
      {
        ...
        institutionAffiliations: ["Juilliard School", "Shanghai Symphony Orchestra"],
        ...
        seoSlug: "piano-teacher-new-york",
      },
      {
        ...
        credentialSummary: "Royal Academy of Music graduate and professional orchestral performer with 12 years of teaching experience.",
        institutionAffiliations: ["Royal Academy of Music", "London Symphony Orchestra"],
        professionalHighlights: "Advanced students prepared for auditions at leading UK conservatoires and youth orchestras.",
        acceptsTrialLessons: true,
        trialLessonPriceInCents: 2500,
        trialLessonDurationMinutes: 30,
        cancellationPolicy: "Cancel at least 24 hours before the lesson to avoid being charged.",
      ...
      },
      {
        ...
        credentialSummary: "Conservatorio di Santa Cecilia graduate with 18 years as a professional performer and educator.",
        institutionAffiliations: ["Conservatorio di Santa Cecilia", "Rome Philharmonic"],
        professionalHighlights: "Students have performed at international guitar competitions and been admitted to leading European conservatories.",
        acceptsTrialLessons: true,
        trialLessonPriceInCents: 2000,
        trialLessonDurationMinutes: 30,
        cancellationPolicy: "48 hours notice required for cancellation.",
        reschedulingPolicy: "One free rescheduling per month with 24 hours notice.",
      ...
      },
      {
        ...
        credentialSummary: "Conservatoire National Supérieur de Paris graduate and internationally acclaimed soprano with 14 years of private teaching.",
        institutionAffiliations: ["Conservatoire de Paris", "Opéra National de Paris", "Royal Opera House"],
        professionalHighlights: "Students have won international vocal competitions and been accepted to the world's leading opera programmes.",
        acceptsTrialLessons: true,
        trialLessonPriceInCents: 3000,
        trialLessonDurationMinutes: 30,
        cancellationPolicy: "Cancel at least 48 hours in advance. Late cancellations are charged at 50%.",
        reschedulingPolicy: "Rescheduling accepted with 48 hours notice.",
        noticeRequiredHours: 48,
      },
      {
        ...
        credentialSummary: "Dual-trained at Tokyo University of the Arts and Berlin Hochschule, with 20 years of orchestral performance.",
        institutionAffiliations: ["Tokyo University of the Arts", "Hochschule für Musik Berlin", "NHK Symphony Orchestra"],
        professionalHighlights: "Students have won positions in professional orchestras across Asia and Europe.",
        acceptsTrialLessons: true,
        trialLessonPriceInCents: 2500,
        trialLessonDurationMinutes: 30,
        cancellationPolicy: "24 hours notice required for cancellation.",
        reschedulingPolicy: "Rescheduling is flexible with advance notice.",
        noticeRequiredHours: 24,
      },
      {
      ...
      },
      {
        ...
        credentialSummary: "Chopin Competition laureate and faculty member at Universität für Musik Wien with 25 years of elite-level teaching.",
        institutionAffiliations: ["Universität für Musik Wien", "Moscow Conservatory", "Chopin Institute"],
        professionalHighlights: "Students have won major international competitions and been appointed to concert careers across Europe.",
        acceptsTrialLessons: true,
        trialLessonPriceInCents: 5000,
        trialLessonDurationMinutes: 45,
        cancellationPolicy: "48 hours notice required. No exceptions for late cancellations.",
        reschedulingPolicy: "Rescheduling available with minimum 72 hours notice.",
